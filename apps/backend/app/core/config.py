...
class Settings(BaseSettings):
    ...
    kafka_client_id: str = Field("shopscale-backend", validation_alias="KAFKA_CLIENT_ID")
    kafka_group_id: str = Field("shopscale-backend", validation_alias="KAFKA_GROUP_ID")
